...
from src.data_utils.dfg_parser.parser_folder.DFG_python import DFG_python
from src.data_utils.dfg_parser.parser_folder.DFG_c import DFG_c
from src.data_utils.dfg_parser.parser_folder.DFG_java import DFG_java
from src.data_utils.dfg_parser.parser_folder import (remove_comments_and_docstrings,
                           tree_to_token_index,
                           index_to_code_token,)
...
def is_valid_variable_python(name: str):
    return name.isidentifier() and not iskeyword(name)

def is_valid_variable_java(name: str):
...
path = '/data/zs/CodeMIA_reconstruct_v2/data/asts/build/my-languages.so'
